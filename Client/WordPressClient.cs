    ...
    public class WordPressClient
    {
        ...
        public async Task<CategoriesList> GetCategoriesList(string site, int? number = null, int? offset = null)
        {
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                categories_list = JsonConvert.DeserializeObject<CategoriesList>(responseString);

                if (categories_list.categories_total_count == 0)
                {
                    Debug.WriteLine("WARNING: GetCategoriesList returned 0 results. Wrong parameters?");
                }
            }
            else if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                Debug.WriteLine(string.Format("ERROR on GetCategoriesList: The site returned: {0}. JetPack not installed on WordPress or JetPack JSON API not active?", Error.message));
            }
        ...
        public async Task<PostsList> GetCategoryPostList(string site, string category, PostType type, PostStatus status, int? number = null, int? offset = null)
        {
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                {
                    Debug.WriteLine("WARNING: GetCategoryPostList returned 0 results. Wrong category name or wrong parameters?");
                }
            }
            else if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                Debug.WriteLine(string.Format("ERROR on GetCategoryPostList: The site returned: {0}. JetPack not installed on WordPress or JetPack JSON API not active?", Error.message));
            }
        ...
        private async Task<HttpResponseMessage> getPosts(string site, PostType type, PostStatus status, int? number = null, int? offset = null)
        {
            if (!number.HasValue)
            {
                number = 10;
            ...
            return await client.GetAsync(new Uri(postUrl(site, type, status, number, offset)));
        }
        ...
        private async Task<HttpResponseMessage> getCatgeories(string site, int? number = null, int? offset = null)
        {
            if (!number.HasValue)
            {
                number = 100;
            ...
            return await client.GetAsync(new Uri(categoriesUrl(site, number, offset)));
        }
        ...
        private async Task<HttpResponseMessage> getCategoryPosts(string site, string category, PostType type, PostStatus status, int? number = null, int? offset = null)
        {
            if (!number.HasValue)
            {
                number = 10;
            ...
            return await client.GetAsync(new Uri(categoryPostsUrl(site, category, type, status, number, offset)));
        }
